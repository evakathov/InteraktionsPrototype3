...
abstract class InteractionDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        private var Instance: InteractionDatabase? = null //a private nullable variable Instance for the database, initialized to null.
        ...
        fun getDatabase(context: Context): InteractionDatabase {
            ...
            return Instance ?: synchronized(this) {
                ...
                Room.databaseBuilder(context, InteractionDatabase::class.java, "interaction_database")
                    .build()
                    .also { Instance = it }
            }
        }
